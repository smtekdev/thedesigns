...
<section class="breadcrumb-area breadcrumb-area3 abbn" style="background: url('images/newimg/webdesignbanimate.gif'); background-size: contain; background-repeat: no-repeat; background-position: center; padding-bottom: 17%; margin-top: -7%;">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<div class="container-fluid txtbn text-center">
    <div class="row">      
      <div class="col-md-12 d-flex align-items-center onhv pad y" style="margin-top: -1%;">
        <div>
          <h2 class="padbn"> Elevate Your Online Presence</h2>
          <p class="padbn">Do you want website that not only looks great but also drives traffic and conversions? Our expert web design team can help you create a website that reflects your brand, engages your audience, and delivers results.

            We specialize in creating custom, responsive websites that are optimized for search engines and designed to convert visitors into customers.</p>        </div>
      </div>
    </div>
</div>
