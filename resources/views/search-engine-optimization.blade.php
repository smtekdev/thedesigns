...
<section class="breadcrumb-area breadcrumb-area3 abbn" style="background: url('images/newimg/seoanimate.gif'); background-size: contain; background-repeat: no-repeat; background-position: center; padding-bottom: 17%; margin-top: -12%;">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
        ...
        <div class="col-md-4 brrd rainbow">
            <div class="text-center">
                <a href="#" class="image-modal img-fluid" data-modal-id="modal1">
                    <img src="images/newimg/seven.png" class="imgcvr">
                  </a>
                  <div id="modal1" class="modal mlimg"><img src="images/newimg/sevenm.png" alt="" class="mlimg1"></div>
          ...
          <div class="col-md-4 brrd rainbow2">
            <div class="text-center">            
                <a href="#" class="image-modal img-fluid " data-modal-id="modal2">
                    <img src="images/newimg/eight.png" class="imgcvr">
                  </a>  
                    <div id="modal2" class="modal mlimg"><img src="images/newimg/eightm.png" alt="" class="mlimg1"></div>
          ...
          <div class="col-md-4 brrd rainbow">
            <div class="text-center">
                <a href="#" class="image-modal img-fluid" data-modal-id="modal3">
                    <img src="images/newimg/nine.png" class="imgcvr">
                  </a>
                  <div id="modal3" class="modal mlimg"><img src="images/newimg/ninem.png" alt="" class="mlimg1"></div>
...
<div class="container-fluid txtbn text-center">
    <div class="row">      
      <div class="col-md-12 d-flex align-items-center onhv pad y" style="margin-top: -1%;">
        <div>
          <h2 class="padbn">Boost Your Online Presence Today</h2>
          <p class="padbn">Our expert team of SEO professionals can help you optimize your website and improve your search engine rankings. With our proven strategies and cutting-edge techniques, we can help you reach the top of search results and increase your visibility to potential customers.

            Our SEO services include keyword research, on-page optimization, link building, content creation, and much more. 
            </p>        </div>
      </div>
    </div>
</div>
...
<!-- Get Qoute Section -->
    ...
    <div class="container-fluid pb" style="background-image: url('images/newimg/seef.jpg');  background-attachment: fixed; padding-top: 12.5%; padding-bottom: 4.5%; margin-top: -4.5%; background-size: cover; margin-top: 26%;">
