...
<section class="breadcrumb-area breadcrumb-area3 abbn" style="background: url('images/aboutusanimate.gif'); background-size: contain; background-repeat: no-repeat; background-position: center; padding-bottom: 17%;">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<section class="about-style3-area about-page">
            ...
            <div class="col-xl-5 col-lg-11 col-md-10 abtc" style="margin-left: 2%;">
                <div class="about-style3-content-box style2">
                    <div class="inner-content">
                        ...
                        <div class="title"><h1>We design and build innovative platforms for inspiring brands</h1></div> 
                        <div class="text">
                            <p>Our experts are specializes in creating cutting-edge platforms that empower inspiring brands to reach their audiences in innovative ways. From concept to launch, we work with you every step of the way to develop tailored solutions that deliver measurable results. Let us help you achieve your promo goals with our customized services.</p>
                        </div>
...
<section class="mission-vision-area marquee33" style="background-image:url(images/mvm.jpg); background-attachment: fixed; padding-top: 11.5%; padding-bottom: 11.5%; margin-top: 6%;">
    <div class="container">
        <div class="top-title text-center"><h1>Mission, Vision & Values</h1></div>
        <div class="row">
            <div class="col-xl-12">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="inner-box text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                                                ...
                                                <div class="text">
                                                    <p>Empowering businesses to thrive in the digital world through innovative solutions, exceptional customer experience, and measurable results.</p>
                                                </div>     
                                            </div>
                                        </div>
                                    </div>    
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="inner-box text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                                                ...
                                                <div class="border-box"></div>
                                                <div class="text">
                                                    <p>Lead digital agency globally, driving transformational growth for our clients and creating a positive impact on society.</p>
                                                </div>   
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="inner-box text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                                                ...
                                                <div class="border-box"></div>
                                                <div class="text">
                                                    <p>Innovation, customer-centricity, collaboration, accountability, and continuous improvement are at the core of how we operate as a digital agency.</p>
                                                </div>   
                                            </div>
                                        </div>
                                    </div>
